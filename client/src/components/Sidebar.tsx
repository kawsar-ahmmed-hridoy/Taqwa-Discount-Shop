...
const Sidebar = ({ sidebarOpen, setSidebarOpen, onLogout }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="px-2 pt-2 pb-3 border-t border-white/[0.055] space-y-1">
        {/* User card */}
        <div
          className={`flex items-center rounded-[9px] bg-white/[0.03] border border-white/[0.055] hover:bg-white/[0.055] transition-colors duration-[120ms] cursor-default
