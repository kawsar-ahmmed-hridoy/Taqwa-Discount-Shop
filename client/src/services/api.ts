...
// Support environments where ImportMetaEnv isn't typed by falling back to any
const API_URL = (import.meta as any).env?.VITE_API_URL || 'https://taqwa-discount-shop.onrender.com/api';
